...
package net.maelbrancke.filip.devoxx.schedule.provider;

import static net.maelbrancke.filip.devoxx.schedule.provider.SessionsContract.AUTHORITY;
...
import net.maelbrancke.filip.devoxx.schedule.provider.SessionsContract.SearchColumns;
...
import net.maelbrancke.filip.devoxx.schedule.provider.SessionsContract.Speakers;
import net.maelbrancke.filip.devoxx.schedule.provider.SessionsContract.SpeakersColumns;
import net.maelbrancke.filip.devoxx.schedule.provider.SessionsContract.SuggestColumns;
...
import net.maelbrancke.filip.devoxx.schedule.provider.SessionsContract.UpdateDatabaseSQL;
